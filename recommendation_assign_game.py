# -*- coding: utf-8 -*-
"""
Created on Thu Nov 23 18:40:50 2023
...
import pandas as pd
anime=pd.read_csv("C:/2-dataset/game.csv")
anime.shape
...
anime.drop(["Titles"],axis=1,inplace=True)

anime.drop(["Category"],axis=1,inplace=True)


anime["game"]=anime["game"].astype(int)

#check outliers

sns.boxplot(anime["Id"])
sns.boxplot(anime["Reviews"])
